...
#if (defined (WIN32) || defined (WIN64)) && defined ( AKSOUNDENGINE_DLL )
...
#else // (defined (WIN32) || defined (WIN64)) && defined ( AKSOUNDENGINE_DLL )
...
#endif // (defined (WIN32) || defined (WIN64)) && defined ( AKSOUNDENGINE_DLL )
